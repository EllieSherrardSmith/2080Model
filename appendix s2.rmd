...
k = 0.2335546                       #This is the k estimate from the mean var and N in study 'Aa'
...
t.vals_Estimated<-data.frame(tvals) #stick it in a dataframe and name the columns
```
...
determining parasite aggregation in host populations. The data used for this analysis are in the supplementary
file ‘SherrardSmithetalDATA.csv’. This file contains the following columns (for more details please see the
main text):
...
dframe1<-read.csv('SherrardSmithetalDATA.csv')
require(lme4)
require(car)
require(MASS)
require(MuMIn)
